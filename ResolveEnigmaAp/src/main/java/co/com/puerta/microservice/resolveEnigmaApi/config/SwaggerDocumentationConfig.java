package co.com.puerta.microservice.resolveEnigmaApi.config;
...
public class SwaggerDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .termsOfServiceUrl("")
            .version("1.0.0")
            .contact(new Contact("","", "gaby-puerta@hotmail.com"))
            .build();
    }
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("co.com.puerta.microservice.resolveEnigmaApi.api"))
